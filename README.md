...
![](http://latex.codecogs.com/svg.image?https://latex.codecogs.com/svg.image?C(r)=\sum_{i=1}^N&space;T_i\left(1-\exp&space;\left(-\sigma_i&space;\delta_i\right)\right)&space;c_i$,&space;where&space;$T_i=\exp&space;\left(-\sum_{j=1}^{i-1}&space;\sigma_i&space;\delta_i\right)))
