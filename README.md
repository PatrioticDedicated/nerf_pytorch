...
$$C(r)=\sum_{i=1}^N T_i\left(1-\exp \left(-\sigma_i \delta_i\right)\right) c_i$$ 

where $$T_i=\exp \left(-\sum_{j=1}^{i-1} \sigma_i \delta_i\right)$$
...
![1](https://latex.codecogs.com/svg.latex?\sum_{i-1}^{N})
